    ...
    students: [
      {
        ...
        attendance: [true, true, true, true, false, false, false, false],
        quizzes: ["9", "7", "4", "9", "7", "", "", ""],
        finalExam: "50",
      },
      {
        ...
        attendance: [true, true, true, false, false, false, false, false],
        quizzes: ["9", "7", "4", "9", "7", "", "", ""],
        finalExam: "44",
      },
    ],
    ...
    students: [
      {
        ...
        price: 300,
        subscriptions: [],
        attendance: [true, true, false, true, true, true, true, false],
        quizzes: ["7", "4", "5", "", "7", "", "", ""],
        finalExam: "49",
      },
    ],
